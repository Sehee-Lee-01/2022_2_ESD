...
### 2) 평가기준: 상(2pts) - 중(1pts) - 하(0pts) 기준 제시
...
### 3) 노트북과 라즈베리파이의 MQTT 무선 통신 서버/클라이언트 구현
- 노트북 로컬 통신

- 라즈베리파이 로컬 통신

- 노트북(`Publisher`)-라즈베리파이(`Subscriber`) 통신

### 4) 무선통신을 통한 라즈베리파이 초음파 센서값 원격 모니터링
### 5) 무선통신을 통한 라즈베리파이 서보모터 원격 제어
- 
